   ...
   <div style="margin-top:100px; margin-bottom:100px">
      <div class="row">
         ...
         <div style="width: 900px;">
            <span style="font-size:18px;">판매</span><span style="color: rgb(247, 47, 51); font-size:20px;">{{listcount}}</span>
            <hr class="cutline">
            <div class="seldel">
                <input type="checkbox" v-model="isAll" @click="all()" /><button @click="sell_del"
...
export default {
    ...
    setup(props, context) {
        ...
        const load = async(page) => {
            ...
            try {
                const res = await axios.get("sell", {params:{id : id, page:page}})
        ...
        const sell_del = async()=> {
            const member_id = props.parent_id;
            console.log("sell_del = "+ member_id);
            console.log(checksave.value);
            ...
            if(answer) {
                try {
                    const res = await axios.delete("sell?" + item_id);
                    console.log(res.data);
