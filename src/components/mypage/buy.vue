   ...
   <div style="margin-top:100px; margin-bottom:100px">
      <div class="row">
                ...
                <div>
                    <aside>
                        ...
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li><router-link class="nav-item nav-link active" :to="{name:'Buy'}">구매 목록</router-link></li>
         ...
         <div style="width: 900px;">
            <span style="font-size:18px;">구매</span><span style="color: rgb(247, 47, 51); font-size:20px;">{{listcount}}</span>
            <hr class="cutline">
            <div class="seldel">
                <input type="checkbox" v-model="isAll" @click="all()" /><button @click="buy_del"
...
export default {
    ...
    setup(props, context) {
        ...
        const load = async(page) => {
            ...
            try {
                const res = await axios.get("buy", {params:{id : id, page:page}})
        ...
        const buy_del = async()=> {
            ...
            if(answer) {
                try {
                    const res = await axios.delete("buy?" + item_id);
                    console.log(res.data);
