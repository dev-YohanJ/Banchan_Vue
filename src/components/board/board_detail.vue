...
export default {
  ...
  setup(){
    ...
    const download = async ()=>{
      ...
      try{
        //Blob(Binary Large Object : Blob 객체는 파일을 text나 2진 데이터 형태로 읽을 수 있다.)
        ...
        //URL.createObjectURL() 정적 메서드는 주어진 객체를 가리키는 url을 DOMString으로 반환한다.
        //DOMString은 UTF-16 문자열이다. JavaScript의 String도 UTF-16 문자열이기 때문에 DOMString은 String으로 연결된다.
        //객체 url을 해제하려면 revokeObjectURL()을 호출한다.
        ...
        //<a href="blob:http://localhost:8081/0cf18723-27f1-496e-8df4-3fddbc861e35" download="webapp구조.png" style="display: none;"></a>
        console.log(a)
    ...
    return {
      board, count, download, showModal
    }
  }
}
</script>
